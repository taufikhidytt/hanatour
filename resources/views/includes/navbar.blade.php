    ...
    <nav class="navbar navbar-expand-lg navbar-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ml-auto">
                ...
                <a class="nav-item nav-link mr-4" href="#popular">Paket Travel</a>
                <a class="nav-item nav-link mr-4" href="#testimonialheading">Testimoni</a>
                ...
                @guest
                <form action="" class="form-inline my-2 my-lg-0 d-none d-md-block">
                    <button class="btn btn-signup btn-navbar-right my-2 my-sm-0 px-4" type="button"
                ...
                {{-- Mobile --}}
                <form action="" class="form-inline d-sm-none d-md-none">
                    <button class="btn btn-signup my-2 my-sm-0" type="button"
                    onclick="event.preventDefault(); location.href='{{ url('register')}}';">
                        Sign Up
                    </button>
                </form>
